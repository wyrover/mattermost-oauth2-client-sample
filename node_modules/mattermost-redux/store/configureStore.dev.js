...
function configureServiceStore(preloadedState, appReducer, userOfflineConfig, getAppReducer) {
    ...
    var store = (0, _redux.createStore)((0, _reduxOffline.createOfflineReducer)(createReducer(_reducers2.default, appReducer)), undefined,
    // eslint-disable-line - offlineCompose(config)(middleware, other funcs)
    (0, _reduxOffline.offlineCompose)(baseOfflineConfig)(middleware, [(0, _remoteReduxDevtools2.default)({
        name: 'Mattermost',
        hostname: 'localhost',
        port: 5678
    })]));
