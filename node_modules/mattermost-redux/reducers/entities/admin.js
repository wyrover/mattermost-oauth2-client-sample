        ...
        case _action_types.UserTypes.REVOKED_USER_ACCESS_TOKEN:
            {
                ...
                for (var i = 0; i < userIds.length; i++) {
                    ...
                    if (state[userId] && state[userId][action.data]) {
                        var _nextUserState2 = _extends({}, state[userId]);
                        Reflect.deleteProperty(_nextUserState2, action.data);
                        return _extends({}, state, _defineProperty({}, userId, _nextUserState2));
                    }
                }
