...
exports.default = function () {
    ...
    if (state.posts === nextState.posts && state.postsInChannel === nextState.postsInChannel && state.selectedPostId === nextState.selectedPostId && state.currentFocusedPostId === nextState.currentFocusedPostId && state.reactions === nextState.reactions && state.openGraph === nextState.openGraph) {
...
function handleReceivedPosts() {
    ...
    postsForChannel.sort(function (a, b) {
        var aIsPendingOrFailed = (0, _post_utils.isPostPendingOrFailed)(nextPosts[a]);
        var bIsPendingOrFailed = (0, _post_utils.isPostPendingOrFailed)(nextPosts[b]);
...
function handlePostsFromSearch() {
    ...
    try {
        for (var _iterator2 = postIds[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var id = _step2.value;
...
function handlePostDeleted() {
    ...
    if (posts[post.id]) {
        ...
        try {
            for (var _iterator3 = channelPosts[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var id = _step3.value;
