...
var getProfilesAndStatusesForPosts = exports.getProfilesAndStatusesForPosts = function () {
    var _ref19 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(posts, dispatch, getState) {
        var state, _state$entities$users, currentUserId, profiles, statuses, userIdsToLoad, statusesToLoad, promises, usernamesToLoad;
    ...
    return function getProfilesAndStatusesForPosts(_x50, _x51, _x52) {
...
var Selectors = _interopRequireWildcard(_posts2);
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 8:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.EDIT_POST_FAILURE, error: _context3.t0 }, (0, _errors.logError)(_context3.t0)(dispatch)]), getState);
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.REACTION_FAILURE, error: _context5.t0 }, (0, _errors.logError)(_context5.t0)(dispatch)]), getState);
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 13:
                            ...
                            return _context7.abrupt('return', reactions);
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            ...
                            (0, _preferences.savePreferences)(currentUserId, [preference])(dispatch, getState);
                ...
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.GET_POST_THREAD_FAILURE, error: _context9.t0 }, (0, _errors.logError)(_context9.t0)(dispatch)]), getState);
                            ...
                            dispatch({
                                ...
                                meta: {
                                    offline: {
                                        ...
                                        rollback: function rollback(success, error) {
                                            (0, _helpers.forceLogoutIfNecessary)(error, dispatch);
                ...
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.GET_POSTS_FAILURE, error: _context11.t0 }, (0, _errors.logError)(_context11.t0)(dispatch)]), getState);
                ...
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.GET_POSTS_SINCE_FAILURE, error: _context13.t0 }, (0, _errors.logError)(_context13.t0)(dispatch)]), getState);
                        ...
                        case 14:
                            ...
                            return _context13.abrupt('return', posts);
                ...
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.GET_POSTS_BEFORE_FAILURE, error: _context15.t0 }, (0, _errors.logError)(_context15.t0)(dispatch)]), getState);
                ...
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        ...
                        case 9:
                            ...
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.GET_POSTS_AFTER_FAILURE, error: _context17.t0 }, (0, _errors.logError)(_context17.t0)(dispatch)]), getState);
                        ...
                        case 14:
                            ...
                            return _context17.abrupt('return', posts);
                ...
                while (1) {
                    switch (_context22.prev = _context22.next) {
                        case 0:
                            ...
                            (0, _preferences.deletePreferences)(currentUserId, [preference])(dispatch, getState);
                ...
                while (1) {
                    switch (_context23.prev = _context23.next) {
                        ...
                        case 8:
                            ...
                            (0, _helpers.forceLogoutIfNecessary)(_context23.t0, dispatch);
                            dispatch((0, _reduxBatchedActions.batchActions)([{ type: _action_types.PostTypes.OPEN_GRAPH_FAILURE, error: _context23.t0 }, (0, _errors.logError)(_context23.t0)(dispatch)]), getState);
