...
var handleReconnect = function () {
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        _context3.next = 6;
                        return (0, _preferences.getMyPreferences)()(dispatch, getState);
                    ...
                    case 6:
                        ...
                        _context3.next = 9;
                        return (0, _teams.getMyTeams)()(dispatch, getState);

                    case 9:
                        _context3.next = 11;
                        return (0, _teams.getMyTeamMembers)()(dispatch, getState);

                    case 11:
                        (0, _teams.getMyTeamUnreads)()(dispatch, getState);
                        ...
                        return _context3.abrupt('return', handleLeaveTeamEvent(newMsg, dispatch, getState));
                    ...
                    case 20:
                        ...
                        return _context3.abrupt('return', (0, _channels.selectChannel)(defaultChannel.id)(dispatch, getState));
                    ...
                    case 26:
                        return _context3.abrupt('return', dispatch({ type: _action_types.GeneralTypes.WEBSOCKET_SUCCESS }, getState));
    ...
    return function handleReconnect(_x6, _x7) {
        return _ref3.apply(this, arguments);
    };
}();

var handleNewPostEvent = function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(msg, dispatch, getState) {
        var state, currentChannelId, users, posts, post, userId, status, otherUserId, markAsRead;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        ...
                        if (status && status !== _constants.General.ONLINE) {
                            (0, _users.getStatusesByIds)([userId])(dispatch, getState);
                        }

                        _context4.t0 = post.type;
                        _context4.next = _context4.t0 === _constants.Posts.POST_TYPES.HEADER_CHANGE ? 12 : _context4.t0 === _constants.Posts.POST_TYPES.PURPOSE_CHANGE ? 14 : 16;
                        break;
                    ...
                    case 16:
                        ...
                        if (msg.data.channel_type === _constants.General.DM_CHANNEL) {
                            otherUserId = (0, _channel_utils.getUserIdFromChannelName)(users.currentUserId, msg.data.channel_name);
                        ...
                        _context4.next = 20;
                        return _client.Client4.getPostThread(post.root_id).then(function (data) {
                            var rootUserId = data.posts[post.root_id].user_id;
                            var rootStatus = users.statuses[rootUserId];
                    ...
                    case 23:
                        ...
                        if (userId === users.currentUserId && !(0, _post_utils.isSystemMessage)(post) && !(0, _post_utils.isFromWebhook)(post)) {
                        ...
                        if (markAsRead) {
                            (0, _channels.markChannelAsRead)(post.channel_id)(dispatch, getState);
                        } else {
    ...
    return function handleNewPostEvent(_x8, _x9, _x10) {
...
var handleTeamAddedEvent = function () {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.next = 2;
                        return (0, _teams.getTeam)(msg.data.team_id)(dispatch, getState);
                    ...
                    case 4:
                        _context5.next = 6;
                        return (0, _teams.getMyTeamUnreads)()(dispatch, getState);
    ...
    return function handleTeamAddedEvent(_x11, _x12, _x13) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            connUrl = siteUrl || _client.Client4.getUrl();
...
function handleChannelDeletedEvent(msg, dispatch, getState) {
    ...
    if (msg.broadcast.team_id === currentTeamId) {
        if (msg.data.channel_id === currentChannelId) {
            var channelId = '';
            var channel = Object.keys(channels).filter(function (key) {
        ...
        dispatch({ type: _action_types.ChannelTypes.RECEIVED_CHANNEL_DELETED, data: msg.data.channel_id }, getState);
...
function handlePreferencesChangedEvent(msg, dispatch, getState) {
    ...
    dispatch({ type: _action_types.PreferenceTypes.RECEIVED_PREFERENCES, data: preferences }, getState);
